...
export function DashBoard() {
  return (
    <div className=" md:flex-col  md:w-[20%] md:h-screen hidden md:block md:border-r-2  mt-3">
      <div className=" mx-5 mb-30 flex justify-center items-center ">
        <img src={logo} alt="" className=" max-w-70" />
      </div>

      <div className="p-4 mx-5 mt-10 hover:shadow-xl ease-in-out duration-500 rounded-lg cursor-pointer">
