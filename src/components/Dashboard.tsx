...
export function DashBoard() {
  return (
    <div className=" md:flex md:flex-col text-neutral-800 md:h-screen hidden  border-r border-black/ w-full px-6  py-6 ">
      ...
      <div className="p-3 mt-10 hover:shadow-sm hover:bg-blue-50 ease-in-out duration-300 rounded-lg cursor-pointer">
