...
export function Appbar() {
  ...
  return (
    <div className="  flex justify-between shadow-lg container items-center">
      ...
      <div className={!Menu ? 'fixed left-0 top-0  w-[80%] cursor-pointer bg-slate-100 h-screen border-y border-4 ease-in-out duration-700' : 'fixed left-[-100%] top-0  w-[60%]  border-r bg-slate-200 border-r-slate-400 h-full ease-in-out duration-700'}>
